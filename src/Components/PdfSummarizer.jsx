...
`;
  ...
  function chat(e) {
    ...
    const body = pdfId
      ? { question: inputValue, pdfId, sessionId } 
      : { question: inputValue, rawSumamry: rawSummary }; 
    ...
    <div className="flex flex-col gap-5">
      ...
      {user && pdfList.length > 0 && (
        <div className="flex justify-center">
          <div className="background-glass rounded-4xl py-3 px-5">
            ...
            <div className="flex gap-2  relative overflow-x-scroll">
              {pdfList.map((pdf) => (
                <button
                  ...
                  className="background-glass  rounded-3xl text-m cursor-pointer hover:opacity-80 min-w-[100%] py-2"
                >
            ...
            {openChatBox && (
              ...
              >
                    ...
                    {question.map((q) => (
                      ...
                      >
                        <div className="w-[50%] text-start  py-2">
                          <div
                            className={
                              q.answer === "" ? "answering-text" : "answertext"
                            }
                          >
                            <ReactMarkdown>
                ...
                >
                  <div>
                    {" "}
                    {user && sessions.length > 0 && openChatBox === true && (
                      <HistoryIcon
